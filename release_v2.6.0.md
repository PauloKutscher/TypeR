...
* **Storage Preservation Update:** The installation scripts (Windows & Mac) will now automatically back up and restore your extension's `storage` folder, guaranteeing your exported styles and custom preferences are perfectly preserved during updates.
