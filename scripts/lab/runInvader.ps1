<#
  runDiag.ps1 — runs scripts/lab/diagInvader.jsx on one page of a run.
...
$outFile = Join-Path $Root ".centering-lab\invader-$Page.json"
$hostJsx = Join-Path $Root "app\host.jsx"
$diag = Join-Path $Root "scripts\lab\diagInvader.jsx"
